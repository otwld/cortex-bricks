...
import { BlockViewer } from './block-viewer/block-viewer';
...
/** PrimeBlocks showcase page with live preview panels. */
@Component({
    selector: 'app-blocks-page',
    imports: [BlockViewer, ButtonModule, Chip, InputText, Checkbox, Password, IconField, InputIcon, FormsModule],

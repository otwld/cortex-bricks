...
/** Full-page 404 not-found view. */
@Component({
  selector: 'app-not-found-page',
  imports: [RouterLink, ButtonModule],
  template: `
    <svg viewBox="0 0 960 540" xmlns="http://www.w3.org/2000/svg" class="min-h-screen min-w-screen fixed left-0" style="bottom:-10rem" preserveAspectRatio="none">
    ...
    <div class="px-8 min-h-screen flex justify-center items-center">
      <div class="z-10 text-center">
        ...
        <p-button [routerLink]="['/']" severity="warn" [raised]="true">Go to Dashboard</p-button>
      </div>
    </div>
  `
})
